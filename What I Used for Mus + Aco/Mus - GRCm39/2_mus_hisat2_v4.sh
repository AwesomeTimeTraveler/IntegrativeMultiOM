...
HISAT2_INDEX="/home/brennan/MUS_GRCm39/GCF_000001635.27/genome_index"
...
for SAMPLE in $SAMPLES; do
        ...
        hisat2 -p -24 --dta -x "$HISAT2_INDEX" -1 "$DATA_DIR/${SAMPLE}_1.fq" -2 "$DATA_DIR/${SAMPLE}_2.fq" -S "$OUTPUT_DIR/aligned_${SAMPLE}>
done
